...
import 'package:mobile_ecommerce/features/shop/screens/product_reviews/widgets/progress_indicator_and_ratings.dart';
    ...
    return Row(
      children: [
        ...
        Expanded(
          ...
          child: Column(
            children: [
              ERatingProgressIndicator(text: '5', value: 1,),
